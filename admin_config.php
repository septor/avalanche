...
if(isset($_POST['updatesettings'])){
	if($_POST['avalanche_rulesrequired'] == true && $_POST['avalanche_rules'] == ""){
		...
		$pref['avalanche_forcevotecomment'] = $tp->toDB($_POST['avalanche_forcevotecomment']);
...
<tr>
<td style='width:50%' class='forumheader3'>Force users to include a comment when they vote?:</td>
<td style='width:50%; text-align:right' class='forumheader3'>
<input type='checkbox' name='avalanche_forcevotecomment' value='1'".($pref['avalanche_forcevotecomment'] == 1 ? " checked='checked'" : "")." />
</td>
</tr>
<tr>
