...
define("ACCEPTIMD", "<img src='".(file_exists(THEME."images/avalanche/accept.png") ? THEME."images/avalanche/accept.png" : e_PLUGIN."avalanche/images/accept.png")."' title='Accept this application!' />");
define("DENYIMAGE", "<img src='".(file_exists(THEME."images/avalanche/deny.png") ? THEME."images/avalanche/deny.png" : e_PLUGIN."avalanche/images/deny.png")."' title='Deny this application!' />");
